        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: screenHeight * 0.02),
              _paymentFinalized ? _buildFinalizedMessage() : const SizedBox
                  .shrink(),
            ],
          ),
        ),
  ...
  Widget _buildFinalizeButton() {
    return Center(
      child: SliderButton(
        ...
        label: Text("Slide to Finalize Payment"),
        buttonColor: Colors.teal.shade400,
      ),
    );
  }

  Widget _buildFinalizedMessage() {
    ...
    return Center(
      child: Row(
        ...
        children: [
          Icon(LucideIcons.checkCircle, color: Colors.green.shade600,
              size: screenWidth * 0.055),
          SizedBox(width: screenWidth * 0.025),
          Text("Payment Finalized!",
              key: const Key("finalizedText"),
              style: TextStyle(
